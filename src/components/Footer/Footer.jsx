...
export const Footer = () => {
  return (
    <div className={S.footer}>
      ...
      <p className={S.contato}><b>Contato:<br/>E-mail: DevsRestHotel@gmail.com<br/>Telefone: 21 00000000</b></p>
      </div>
      </div>
      <FormNewsLetter/>
      <div className={S.redes}>
        <p className={S.direitos}><b>2022 © Direitos Reservados - Dev´s Rest Hotel</b></p>
        <nav className={S.nav}>
        <Button href="#text-buttons"><AiOutlineFacebook size={20} className={S.icons}/></Button>
        <Button href="#text-buttons"><AiOutlineTwitter size={20} className={S.icons}/></Button>
